...
$SeguimentoT = 
        array(
                  ...
                  ,"CodMovRetorno_C044"=>array("nCmp"=>"07.3T","desc"=>"Código de Movimento Retorno ","posInicio"=>"16","posFim"=>"17","leng"=>"2","Dec"=>"- ","type"=>"Numérico","default"=>"","codFebraban"=>"C044","listFields"=>
                        ...
                        "))
                  ,"NumAgencia_G008"=>array("nCmp"=>"08.3T","desc"=>"Agência Mantenedora da Conta ","posInicio"=>"18","posFim"=>"22","leng"=>"5","Dec"=>"- ","type"=>"Numérico","default"=>"","codFebraban"=>"G008","listFields"=>" ")
                  ,"DVAgencia_G009"=>array("nCmp"=>"09.3T","desc"=>"Dígito Verificador da Agência ","posInicio"=>"23","posFim"=>"23","leng"=>"1","Dec"=>"- ","type"=>"Numérico","default"=>"","codFebraban"=>"G009","listFields"=>" ")
                  ...
                  ,"NumAgencia_G008"=>array("nCmp"=>"19.3T","desc"=>"Agência Cobradora/Recebedora ","posInicio"=>"100","posFim"=>"104","leng"=>"5","Dec"=>"- ","type"=>"Numérico","default"=>"","codFebraban"=>"G008","listFields"=>" ")
                  ,"DVAgencia_G009"=>array("nCmp"=>"20.3T","desc"=>"Dígito Verificador da Agência ","posInicio"=>"105","posFim"=>"105","leng"=>"1","Dec"=>"- ","type"=>"Numérico","default"=>"","codFebraban"=>"G009","listFields"=>" ")
...
//@todo SeguimentoU
$SegmentoU = array(
	"NomeCampo" =>    array("nCmp"=>"01.3U","desc"=>"Código do Banco na Compensação 	","posInicio"=>"1","posFim"=>"3","leng"=>"3","Dec"=>"0","type"=>"Num","default"=>"001","codFebraban"=>"G001","listFields"=>"")
	,"NomeCampo" =>    array("nCmp"=>"02.3U","desc"=>"Lote de Serviço					","posInicio"=>"4","posFim"=>"7","leng"=>"4","Dec"=>"0","type"=>"Num","default"=>"","codFebraban"=>"G002","listFields"=>"")
	,"NomeCampo" =>    array("nCmp"=>"03.3U","desc"=>"Tipo de Registro 					","posInicio"=>"8","posFim"=>"8","leng"=>"1","Dec"=>"0","type"=>"Num","default"=>"‘3’ ","codFebraban"=>"G003","listFields"=>"")
	,"NomeCampo" =>    array("nCmp"=>"04.3U","desc"=>"Nº Sequencial do Registro no Lote ","posInicio"=>"9","posFim"=>"13","leng"=>"5","Dec"=>"0","type"=>"Num","default"=>"","codFebraban"=>"G038","listFields"=>"")
	,"NomeCampo" =>    array("nCmp"=>"05.3U","desc"=>"Cód. Segmento do Registro Detalhe ","posInicio"=>"14","posFim"=>"14","leng"=>"1","Dec"=>"0","type"=>"Alpha","default"=>"‘U’ ","codFebraban"=>"G039","listFields"=>"")
	,"NomeCampo" =>    array("nCmp"=>"06.3U","desc"=>"Uso Exclusivo FEBRABAN/CNAB 		","posInicio"=>"15","posFim"=>"15","leng"=>"1","Dec"=>"0","type"=>"Alpha","default"=>"Brancos ","codFebraban"=>"G004","listFields"=>"")
	...
	,"NomeCampo" =>    array("nCmp"=>"08.3U","desc"=>"Juros / Multa / Encargos 			","posInicio"=>"18","posFim"=>"32","leng"=>"13","Dec"=>"2","type"=>"Num","default"=>"","codFebraban"=>"C048","listFields"=>"")
	,"NomeCampo" =>    array("nCmp"=>"09.3U","desc"=>"Valor do Desconto Concedido 		","posInicio"=>"33","posFim"=>"47","leng"=>"13","Dec"=>"2","type"=>"Num","default"=>"","codFebraban"=>"C049","listFields"=>"")
	,"NomeCampo" =>    array("nCmp"=>"10.3U","desc"=>"Valor do Abat. Concedido/Cancel. 	","posInicio"=>"48","posFim"=>"62","leng"=>"13","Dec"=>"2","type"=>"Num","default"=>"","codFebraban"=>"C050","listFields"=>"")
	,"NomeCampo" =>    array("nCmp"=>"11.3U","desc"=>"Valor do IOF Recolhido			","posInicio"=>"63","posFim"=>"77","leng"=>"13","Dec"=>"2","type"=>"Num","default"=>"","codFebraban"=>"G077","listFields"=>"")
	,"NomeCampo" =>    array("nCmp"=>"12.3U","desc"=>"Valor Pago pelo Sacado 			","posInicio"=>"78","posFim"=>"92","leng"=>"13","Dec"=>"2","type"=>"Num","default"=>"","codFebraban"=>"C052","listFields"=>"")
	,"NomeCampo" =>    array("nCmp"=>"13.3U","desc"=>"Valor Líquido a ser Creditado 	","posInicio"=>"93","posFim"=>"107","leng"=>"13","Dec"=>"2","type"=>"Num","default"=>"","codFebraban"=>"G078","listFields"=>"Valor pago pelo sacado menos a tarifa.")
	,"NomeCampo" =>    array("nCmp"=>"14.3U","desc"=>"Valor de Outras Despesas 			","posInicio"=>"108","posFim"=>"122","leng"=>"13","Dec"=>"2","type"=>"Num","default"=>"","codFebraban"=>"C054","listFields"=>"")
	,"NomeCampo" =>    array("nCmp"=>"15.3U","desc"=>"Valor de Outros Créditos 			","posInicio"=>"123","posFim"=>"137","leng"=>"13","Dec"=>"2","type"=>"Num","default"=>"","codFebraban"=>"C055","listFields"=>"")
	,"NomeCampo" =>    array("nCmp"=>"16.3U","desc"=>"Data da Ocorrência 				","posInicio"=>"138","posFim"=>"145","leng"=>"8","Dec"=>"0","type"=>"Num","default"=>"","codFebraban"=>"C056","listFields"=>"")
	,"NomeCampo" =>    array("nCmp"=>"17.3U","desc"=>"Data da Efetivação do Crédito 	","posInicio"=>"146","posFim"=>"153","leng"=>"8","Dec"=>"0","type"=>"Num","default"=>"","codFebraban"=>"C057","listFields"=>"")
	,"NomeCampo" =>    array("nCmp"=>"18.3U","desc"=>"Código da Ocorrência 				","posInicio"=>"154","posFim"=>"157","leng"=>"4","Dec"=>"0","type"=>"Alpha","default"=>"","codFebraban"=>"A001","listFields"=>"Não informado no retorno.")
	,"NomeCampo" =>    array("nCmp"=>"19.3U","desc"=>"Data da Ocorrência 				","posInicio"=>"158","posFim"=>"165","leng"=>"8","Dec"=>"0","type"=>"Alpha","default"=>"","codFebraban"=>"C058","listFields"=>"Não informado no retorno.")
	,"NomeCampo" =>    array("nCmp"=>"20.3U","desc"=>"Valor da Ocorrência 				","posInicio"=>"166","posFim"=>"180","leng"=>"13","Dec"=>"2","type"=>"Num","default"=>"","codFebraban"=>"C059","listFields"=>"Não informado no retorno.")
	,"NomeCampo" =>    array("nCmp"=>"21.3U","desc"=>"Complem. da Ocorrência 			","posInicio"=>"181","posFim"=>"210","leng"=>"30","Dec"=>"0","type"=>"Alpha","default"=>"","codFebraban"=>"A002","listFields"=>"Não informado no retorno.")
	,"NomeCampo" =>    array("nCmp"=>"22.3U","desc"=>"Cód. Banco Correspondente Compens.","posInicio"=>"211","posFim"=>"213","leng"=>"3","Dec"=>"0","type"=>"Num","default"=>"","codFebraban"=>"C031","listFields"=>"Não informado no retorno.")
	,"NomeCampo" =>    array("nCmp"=>"23.3U","desc"=>"Nosso Nº Banco Correspondente 	","posInicio"=>"214","posFim"=>"233","leng"=>"20","Dec"=>"0","type"=>"Num","default"=>"","codFebraban"=>"C032","listFields"=>"Não informado no retorno.")
	,"NomeCampo" =>    array("nCmp"=>"24.3U","desc"=>"Uso Exclusivo FEBRABAN/CNAB 		","posInicio"=>"234","posFim"=>"240","leng"=>"7","Dec"=>"0","type"=>"Alpha","default"=>"Brancos ","codFebraban"=>"G004","listFields"=>"")
);
