...
$headerArquivo = array(    
    ...
    ,"FEBRABAN2_G004"      =>array("nCmp"=>"4.0", "posInicio"=>"133","posFim"=>"142","leng"=>"10","Dec"=>"","type"=>"Alpha","Default"=>" ",   "valueReplace"=>" ")            
...
$SeguimentoP = array(
            ...
            ,"BB_VlrNominalTit_G070"=>  array("nCmp"=>"21.3","posInicio"=>"86", "posFim"=>"100","leng"=>"13","Dec"=>"2","type"=>"Num",  "Default"=>"", "valueReplace"=>"")  /* Obs no manual pg 9*/
            ,"CX_VlrNominalTit_G070"=>  array("nCmp"=>"21.3","posInicio"=>"86", "posFim"=>"100","leng"=>"13","Dec"=>"2","type"=>"Num",  "Default"=>"", "valueReplace"=>"")  /* Obs no manual pg 9*/
